...
'admin disabled because not supported on google welcome engine': 'admin disabled because not supported on google welcome engine',
...
'Error': 'Error',
'Error logs for "%(welcome)s"': 'Error logs for "%(welcome)s"',
...
'Overwrite installed welcome': 'Overwrite installed welcome',
