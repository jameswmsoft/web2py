...
'admin disabled because not supported on google welcome engine': 'amministrazione non supportata da Google Apps Engine',
...
'appadmin': 'appadmin ',
'appadmin is disabled because insecure channel': 'amministrazione welcome (appadmin) disabilitata: comunicazione non sicura',
...
'Cannot compile: there are errors in your welcome:': "Compilazione fallita: ci sono errori nell'applicazione.",
...
'Error': 'Error',
'Error logs for "%(welcome)s"': 'Log degli errori per "%(welcome)s"',
...
'or provide welcome url:': "oppure fornisci url dell'applicazione:",
'Original/Translation': 'Originale/Traduzione',
'Overview': 'Overview',
'Overwrite installed welcome': 'sovrascrivi applicazione installata',
...
'Start a new welcome': 'Start a new welcome',
...
'Unable to download welcome because:': 'Impossibile scaricare applicazione perché',
