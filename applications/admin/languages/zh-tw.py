...
'admin disabled because not supported on google welcome engine': '管理介面關閉原因是不支援在google apps engine環境下運作',
...
'Cannot compile: there are errors in your welcome.        Debug it, correct errors and try again.': '無法編譯:應用程式中含有錯誤，請除錯後再試一次.',
'Cannot compile: there are errors in your welcome:': '無法編譯: 在你的應用程式存在錯誤:',
...
'Error': 'Error',
'Error logs for "%(welcome)s"': '"%(welcome)s"的錯誤紀錄',
...
'or provide welcome url:': '或是提供應用程式的安裝網址:',
'Origin': '原文',
'Original/Translation': '原文/翻譯',
'Overview': 'Overview',
'Overwrite installed welcome': '覆蓋已安裝的應用程式',
'Pack all': '全部打包',
...
'Unable to download welcome': '無法下載應用程式',
'Unable to download welcome because:': '無法下載應用程式因為:',
