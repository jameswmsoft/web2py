...
'admin disabled because not supported on google welcome engine': 'admin désactivée car non prise en charge sur Google Apps engine',
...
'Cannot compile: there are errors in your welcome.        Debug it, correct errors and try again.': 'Ne peut pas compiler: il y a des erreurs dans votre application. corriger les erreurs et essayez à nouveau.',
'Cannot compile: there are errors in your welcome:': 'Ne peut pas compiler: il y a des erreurs dans votre application:',
...
'Error': 'Error',
'Error logs for "%(welcome)s"': 'Journal d\'erreurs pour "%(welcome)s"',
...
'Install': 'Installer',
'Installation of %(plugin)s for %(welcome)s': 'Installation of %(plugin)s for %(welcome)s',
...
'Open new welcome in new window': 'Open new welcome in new window',
...
'or provide welcome url:': "ou fournir l'URL de l'welcome:",
'or provide application url:': "ou fournir l'URL de l'application:",
'Original/Translation': 'Original / Traduction',
'Overview': 'Overview',
'Overwrite installed welcome': "Écraser l'application installée",
...
'Start a new welcome': 'Commencer une nouvelle application',
...
'The welcome exists, was created by wizard, continue to overwrite!': 'The welcome exists, was created by wizard, continue to overwrite!',
'The welcome exists, was NOT created by wizard, continue to overwrite!': 'The welcome exists, was NOT created by wizard, continue to overwrite!',
...
'These files are not served, they are only available from within your welcome': 'These files are not served, they are only available from within your welcome',
...
"This page can commit your changes to an openshift welcome repo and push them to your cloud instance. This assumes that you've already created the application instance using the web2py skeleton and have that repo somewhere on a filesystem that this web2py instance can access. This functionality requires GitPython installed and on the python path of the runtime that web2py is operating in.": "This page can commit your changes to an openshift welcome repo and push them to your cloud instance. This assumes that you've already created the application instance using the web2py skeleton and have that repo somewhere on a filesystem that this web2py instance can access. This functionality requires GitPython installed and on the python path of the runtime that web2py is operating in.",
'This page can upload your application to the Google App Engine computing cloud. Mind that you must first create indexes locally and this is done by installing the Google appserver and running the welcome locally with it once, or there will be errors when selecting records. Attention: deployment may take long time, depending on the network speed. Attention: it will overwrite your welcome.yaml. DO NOT SUBMIT TWICE.': 'This page can upload your application to the Google App Engine computing cloud. Mind that you must first create indexes locally and this is done by installing the Google appserver and running the welcome locally with it once, or there will be errors when selecting records. Attention: deployment may take long time, depending on the network speed. Attention: it will overwrite your welcome.yaml. DO NOT SUBMIT TWICE.',
...
'Unable to download welcome': "Impossible de télécharger l'welcome",
'Unable to download welcome because:': "Impossible de télécharger l'welcome car:",
...
'Users': 'Utilisateurs',
'Using the shell may lock the database to other users of this welcome.': 'Using the shell may lock the database to other users of this welcome.',
'variables': 'variables',
'Version': 'Version',
