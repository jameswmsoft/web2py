...
'admin disabled because not supported on google welcome engine': 'administrare dezactivată deoarece funcționalitatea nu e suportat pe Google App Engine',
...
'Cannot compile: there are errors in your welcome.        Debug it, correct errors and try again.': 'Compilare imposibilă: aplicația conține erori. Debogați aplicația și încercați din nou.',
'Cannot compile: there are errors in your welcome:': 'Cannot compile: there are errors in your welcome:',
...
'Error': 'Eroare',
'Error logs for "%(welcome)s"': 'Log erori pentru "%(welcome)s"',
...
'Overwrite installed welcome': 'Suprascrie aplicație instalată',
...
'Start a new welcome': 'Începe o nouă aplicație',
...
'Unable to download welcome': 'Imposibil de descărcat aplicația',
'Unable to download welcome because:': 'Unable to download welcome because:',
